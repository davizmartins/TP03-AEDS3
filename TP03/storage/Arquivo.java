...
public class Arquivo<T extends Registro> {
    protected static final String DIRETORIO_DADOS = ".\\TP03\\dados";
    ...
    public Arquivo(String na, Constructor<T> c) throws Exception {
        File d = new File(DIRETORIO_DADOS);
        if(!d.exists())
            d.mkdirs();

        d = new File(DIRETORIO_DADOS+"\\"+na);
        if(!d.exists())
            d.mkdirs();

        this.nomeArquivo = DIRETORIO_DADOS+"\\"+na+"\\"+na+".db";
        this.construtor = c;
        ...
        indiceDireto = new HashExtensivel<>(
            ...
            4, 
            DIRETORIO_DADOS+"\\"+na+"\\"+na+".d.db", // diretório 
            DIRETORIO_DADOS+"\\"+na+"\\"+na+".c.db"  // cestos
        );
    }
